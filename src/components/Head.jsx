...
function Header(){
    ...
    return <>
     <div className="flex justify-around gap-20 py-2 fixed top-0 left-0 w-full bg-white text-black opacity-50 shadow-md z-10">
        ...
        <div style={{display: hidden=== true ? "block" : ""}} className="absolute sm:static  top-10 bg-white sm:bg-transparent sm:text-black sm:mt-0 text-black  sm:w-auto w-32 text-center mt-4 sm:space-y-0 space-y-3 sm:pb-0 pb-3 sm:flex hidden ">
